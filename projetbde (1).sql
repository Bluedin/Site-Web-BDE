...
--
-- Client :  127.0.0.1
-- Généré le :  Jeu 20 Avril 2017 à 16:16
...
CREATE TABLE IF NOT EXISTS `store` (
  `id` int(9) NOT NULL AUTO_INCREMENT,
  `nomproduit` varchar(500) NOT NULL,
...
INSERT INTO `store` (`id`, `nomproduit`, `prix`, `photo`) VALUES
(1, 'Sweat Exia', 35, 'sweatexia.jpg'),
(2, 'Polo Exia Projet Web', 25, 'tshirtexia.jpg'),
(3, 'Dark Cookies', 1000, 'darkcookie.jpg'),
(4, 'Mon pied', 50000, 'piedelmander.jpg');
...
INSERT INTO `user` (`id`, `nom`, `prenom`, `mail`, `password`, `promo`, `phrasechoc`, `avatar`) VALUES
(7, 'Spada', 'RÃ©my', 'remy.spada@live.fr', 'elmandr', 'A2', 'tfc', NULL),
(8, 'Elmander', 'Johan', 'elmander@live.fr', 'elmander', 'A2', 'trois zero contre bordeaux lol', NULL);
