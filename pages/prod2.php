      ...
      <div class="row">
          ...
          <div class="col-lg-6">
           ...
           <div class="col-lg-6">
                ...
                <div class="caption">
                  <h3>Polo Exia Projet Web</h3>
                  <p>Prix : <strong>25€</strong></p>
                  
                    <label>Envie d'un flocage ? Cochez la case ci contre et écrivez votre pseudo !</label>
                    <div class="input-group">
                    <span class="input-group-addon"><input type="checkbox"></span>
                    <input type="text" class="form-control">
                  </div>
                  </br>
                  <p><a href="confirmationachat.php" class="btn btn-primary">Acheter</a> </p>
